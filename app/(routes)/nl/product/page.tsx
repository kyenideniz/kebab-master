                ...
                <div className=" w-full lg:p-12 md:p-12 sm:p-2 xs:p-2">
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="text-start">
                            <div className="lg:text-5xl md:text-5xl sm:text-3xl xs:text-3xl text-red-500 font-normal lg:p-8 md:p-8 sm:p-2 xs:p-2">
                                Kenmerken van Doner-robot
                            </div>
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Hygiënisch en snijdbaar zonder aanraking.</div>
                                <div>Gemakkelijk te gebruiken zonder ervaring.</div>
                                <div>Kan 24 uur per dag werken.</div>
                                <div>Kan döner op de gewenste dikte snijden, nauwkeurig en continu.</div>
                                <div>Speciaal vleessnijmes.</div>
                                <div>Homogeen donerkoken dankzij hitteschilden.</div>
                                <div>Duurzame stralingsverwarmers en draden.</div>
                                <div>Laag energieverbruik.</div>
                                <div>Onderdelen kunnen eenvoudig worden gedemonteerd en gereinigd.</div>
                                <div>Lagere personeelskosten</div>
                                <div>Lagere personeelskosten Het probleem van het vinden van werknemers oplossen</div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="text-start">
                            ...
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Verlaagt de totale bedrijfskosten.</div>
                                <div>Brengt prestige naar het bedrijf.</div>
                                <div>Instelbaar motortoerental.</div>
                                <div>Olie-geïsoleerde donermotor.</div>
                                <div>Voorwaartse en achterwaartse beweging van de donergrill.</div>
                                <div>Verhoogde kwaliteit</div>
                                <div>Consistente smaak</div>
                                <div>Lagere productiekosten</div>
                                <div>Verbeterd concurrentievermogen</div>
                                <div>Minder arbeidsongevallen</div>
                                <div>Tijdbesparing</div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 py-12">
                        <div className="text-start">
                            ...
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Vast laag tarief</div>
                                <div>Geen aanbetaling</div>
                                <div>Geen investering vereist</div>
                                <div>Goedkeuring binnen 4 uur</div>
                                <div>Optimaal gebruik van werkkapitaal</div>
                                <div>Geen hoge aanschafkosten</div>
                                <div>Economisch risico gedragen door de leasemaatschappij</div>
                                <div>Mogelijkheid tot eigendom</div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Makkelijk te Gebruiken</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">De Döner-robots zijn uiterst eenvoudig te bedienen en zorgen ervoor dat het personeel sneller en effectiever kan werken, waardoor de keukenwerkzaamheden efficiënter worden.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full  lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Snelheid en Efficiëntie</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Automatische donerrobots zorgen ervoor dat restaurants snelle service kunnen bieden. Ze zijn ideaal voor bedrijven die in korte tijd hoogwaardige dienstverlening bieden.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 text-4xl font-bold items-center justify-center flex">Kostenbesparingen</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Doner-robots verminderen de behoefte aan menselijke arbeid, tegen lagere kosten. Dit bespaart personeelskosten en maakt bedrijfsprocessen efficiënter.</div>
                            </div>
                        </div>
                    </div>
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 py-8 ">
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Aanpasbaarheid</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Doner-robots kunnen worden geprogrammeerd voor verschillende menu&apos;s en de eisen van de klant verbeteren de servicekwaliteit en maximaliseren de klanttevredenheid.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Innovatie</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Doner-robots worden voortdurend bijgewerkt en uitgerust met nieuwe functies. Dit helpt bedrijven hun concurrentievoordeel te behouden.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Minimaal foutenpercentage</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Door binnen geprogrammeerde parameters te werken, minimaliseren donerrobots menselijke fouten. Dit zorgt keer op keer voor consistente en succesvolle resultaten.</div>
                            </div>
                        </div>
                    </div>
                    <div className="p-8 w-full h-full">
                        <Button className="bg-[#cf0a2c] w-full h-full text-lg text-white"><Link href={"/nl/contact"}>Contact</Link></Button>
                    </div>
                </div>  
            </div>
        </div>
