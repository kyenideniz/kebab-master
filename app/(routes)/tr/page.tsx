...
import { HeightCorousel } from "@/components/heightCorousel";
    ...
    <div className="p-2 w-full">
      <div className="lg:p-12 sm:p-4 w-full items-center justify-center flex">
        <div className="lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg grid grid-cols-5 grid-rows-2 w-full space-x-3 relative "> 
          ...
          <div className="lg:h-[92px] md:h-[82px] sm:h-[72px] bg-slate-300 col-start-5 row-start-2 absolute right-0 bottom-0">
            <Image 
          ...
          <div className="space-x-4 col-span-3 w-full col-start-2 row-start-2 row-span-1 absolute lg:-bottom-4 md:-bottom-4 sm:-bottom-8 xs:-bottom-8 grid grid-cols-12 ">
            <Input placeholder="İletişim Adresi" className="col-span-10 sm:col-span-8 xs:col-span-8 w-full lg:h-16 md:h-12 sm:h-8 rounded-none text-xl shadow-lg border-0" />
            <Button className=" bg-[#cf0a2c] col-span-2 sm:col-span-4 xs:col-span-4 lg:h-16 md:h-12 sm:h-8 lg:text-lg md:text-base sm:text-xs rounded-none"><Link href={"/tr/contact"}>Gönder</Link></Button>
          </div>
        </div>  
      </div>
      ...
      <div className="items-center justify-center flex">
        <div className="max-w-7xl w-full">
          <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="border-t-[2px] py-6 lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] font-bold" >Makinelerimiz hakkında daha fazla bilgi edinin</AccordionTrigger>
            </AccordionItem>
          </Accordion>
          <div className="py-8">
            <HeightCorousel />
        ...
        <div className="max-w-7xl w-full border-t-[2px]">
          <div className="lg:p-6 md:p-6 sm:p-0 xs:p-0 lg:pt-12 md:pt-12 sm:pt-0 xs:pt-0 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-4 xs:grid-cols-4 ">
            <div className="lg:p-4 lg:py-8 md:p-4 md:py-8 sm:p-2 sm:py-0 xs:p-2 xs:py-0 lg:col-span-1 md:col-span-1 sm:col-span-3 xs:col-span-3">
              <div className="lg:py-6 md:py-6 sm:py-2 xs:py-2 text-4xl lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] font-bold">Kolayca ulaşın!</div>
              <div className="lg:py-6 md:py-6 sm:py-2 xs:py-2  lg:text-2xl md:text-2xl sm:text-lg xs:text-base lg:text-justify md:text-justify sm:text-left xs:text-left">DonerRobot ile birinci sınıf makine çözümlerini deneyimleyin. İş ihtiyaçlarınıza yönelik çeşitli seçeneklere göz atın.</div>
              <div className="py-6">
                <Button className=" bg-[#cf0a2c] lg:h-16 md:h-16 sm:h-10 xs:h-10 w-1/3 lg:text-xl md:text-xl sm:text-base xs:text-base rounded-none"><Link href={"/tr/contact"}>Bize ulaşın</Link></Button>
              </div>
            </div>
           
            <div className="relative items-center justify-center flex h-full w-full lg:col-span-1 md:col-span-1 sm:col-span-1 xs:col-span-1">
              <Image 
                src={"/banner/banner-right.png"} 
                alt={"left"}            
                width={1080}
