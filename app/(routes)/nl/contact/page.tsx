    ...
    const onSubmit = async (data: ContactFormValues) => {
        try {
            ...
            toast({
                ...
                description: "Er was een probleem met je verzoek.",
                action: <ToastAction altText="Probeer het nog eens">Probeer het nog eens</ToastAction>,
            })
        } finally {
            setLoading(false);
        }
                            ...
                            <div className="grid grid-cols-2 w-full">
                                <div className="">
                                    <div className="lg:text-2xl md:text-2xl sm:text-xl xs:text-xl py-6">
                                        ...
                                        <div className="inline h-[40px] aspect-square">Telefoonnummer</div>
                                    </div>
                                ...
                                <div>
                                    <div className="lg:text-2xl md:text-2xl sm:text-xl xs:text-xl py-6">
                                        ...
                                        <div className="inline h-[40px] aspect-square">E-Mail Adres</div>
                                    </div>
                            ...
                            <div className="grid grid-cols-2 pt-8 ">
                                <div>
                                    <div className="lg:text-2xl md:text-2xl sm:text-xl xs:text-xl pb-6">
                                        ...
                                        <div className="inline h-[40px] aspect-square">Plaats</div>
                                    </div>
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-8">
                                    ...
                                    <div className="grid grid-cols-2">
                                        <div className="pb-6 pr-3">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel className="text-xl pl-3 py-3">Voornaam</FormLabel>
                                                            <FormControl>
                                                                <Input 
                                                                    type="text" 
                                                                    disabled={loading} 
                                        ...
                                        <div className="pb-6 pl-3">
                                            <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel className="text-xl pl-3 py-3">Achternaam</FormLabel>
                                                            <FormControl>
                                                                <Input 
                                                                    type="text" 
                                                                    disabled={loading} 
                                    ...
                                    <div>
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="pb-4">Message</FormLabel>
                                                    <FormControl>
                                                        <Textarea 
