      ...
      <div className="lg:p-12 sm:p-4 w-full items-center justify-center flex">
        <div className="lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg grid grid-cols-5 grid-rows-2 w-full space-x-3 relative "> 
          ...
          <div className="space-x-4 col-span-3 w-full col-start-2 row-start-2 row-span-1 absolute lg:-bottom-4 md:-bottom-4 sm:-bottom-8 xs:-bottom-8 grid grid-cols-12 ">
            ...
            <Button className=" bg-[#cf0a2c] col-span-2 sm:col-span-4 xs:col-span-4 lg:h-16 md:h-12 sm:h-8 lg:text-lg md:text-base sm:text-xs rounded-none"><Link href={"/en/contact"}>Submit</Link></Button>
          </div>
        </div>  
      </div>
        ...
        <div className="max-w-7xl w-full">
          <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="border-t-[2px] py-6 lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] font-bold" >Learn more about our machines</AccordionTrigger>
            </AccordionItem>
          </Accordion>
          ...
          <div className=" w-full h-full grid lg:grid-rows-2 md:grid-rows-2 sm:grid-rows-1 xs:grid-rows-1 place-items-center justify-items-center px-6">
            <div className="row-start-1 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg">
              <div className="lg:border-r-[2px] md:border-r-[2px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">24/7 Operation</div>
                <div className="py-4 text-xl text-justify">Achieve continuous, hygienic, and sterile operation 24/7 with our advanced machine. Perfect for maintaining top-quality standards without compromise.</div>
              </div>
              <div className=" lg:border-r-[2px] md:border-r-[0px] sm:border-b-[2px] xs:border-b-[2px] p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Precision Cutting</div>
                <div className="py-4 text-xl text-justify">Experience the precision of our cutting-edge doner kebab machines. Each machine is crafted to deliver unparalleled slicing accuracy, ensuring every cut is perfect.</div>
              </div>
              <div className="md:text-center lg:border-r-[0px]  sm:border-b-[2px] xs:border-b-[2px] lg:col-span-1 md:col-span-2 sm:col-span-1 xs:col-span-1 p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] md:items-center md:justify-center sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Easy Cleaning</div>
                <div className="py-4 text-xl lg:text-justify md:text-center sm:text-justify xs:text-justify">Crafted from durable stainless steel, our machine ensures easy cleaning and maintenance. Enjoy hygienic operations effortlessly with a sleek, modern design that meets all sanitation standards.</div>
              </div>
            </div>
            ...
            <div className=" row-start-2 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg">
              <div className="lg:border-r-[2px] lg:border-b-0 md:border-r-[2px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Adjustable Cuts</div>
                <div className="py-4 text-xl text-justify">Our machine features programmable cutting angles and durations, offering precise control over every slice. Customize your settings for optimal results and consistency with ease.</div>
              </div>
              <div className="lg:border-r-[2px] lg:border-b-0 md:border-r-[0px] md:border-t-[0px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Kitchen Security</div>
                <div className="py-4 text-xl text-justify">Ensuring a safe working environment, our machine includes an emergency stop button for added peace of mind. Prioritize safety without compromising efficiency.</div>
              </div>
              <div className="md:text-center lg:border-r-[0px] md:border-b-0 sm:border-b-[0px] xs:border-b-[0px] lg:col-span-1 md:col-span-2 sm:col-span-1 xs:col-span-1 p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] md:items-center md:justify-center sm:items-center sm:justify-center xs:items-center xs:justify-center flex ">Energy Efficiency</div>
                <div className="py-4 text-xl lg:text-justify md:text-center sm:text-justify xs:text-justify">Achieve cost savings with our machine&apos;s low energy consumption, designed for efficiency without compromising performance. Optimize your operations while reducing overheads effortlessly.</div>
              </div>
        ...
        <div className="max-w-7xl w-full border-t-[2px]">
          <div className="lg:p-6 md:p-6 sm:p-0 xs:p-0 lg:pt-12 md:pt-12 sm:pt-0 xs:pt-0 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-4 xs:grid-cols-4 ">
            <div className="lg:p-4 lg:py-8 md:p-4 md:py-8 sm:p-2 sm:py-0 xs:p-2 xs:py-0 lg:col-span-1 md:col-span-1 sm:col-span-3 xs:col-span-3">
              ...
              <div className="py-6">
                <Button className=" bg-[#cf0a2c] lg:h-16 md:h-16 sm:h-10 xs:h-10 w-1/3 lg:text-xl md:text-xl sm:text-base xs:text-base rounded-none"><Link href={"/en/contact"}>Contact</Link></Button>
              </div>
            </div>
