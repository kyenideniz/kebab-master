                ...
                <div className=" w-full lg:p-12 md:p-12 sm:p-2 xs:p-2">
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="text-start">
                            <div className="lg:text-5xl md:text-5xl sm:text-3xl xs:text-3xl text-red-500 font-normal lg:p-8 md:p-8 sm:p-2 xs:p-2">
                                Döner Robotunun Özellikleri
                            </div>
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Hijyeniktir ve el değmeden dilimlenebilir.</div>
                                <div>Deneyim gerektirmeden kullanımı kolaydır.</div>
                                <div>Günün 24 saati çalışabilir.</div>
                                <div>Döneri istenilen kalınlıkta, hassas ve sürekli dilimleyebilir.</div>
                                <div>Özel et dilimleme bıçağı.</div>
                                <div>Isı kalkanları sayesinde homojen döner pişirme.</div>
                                <div>Uzun ömürlü radyant ısıtıcılar ve teller.</div>
                                <div>Düşük enerji tüketimi.</div>
                                <div>Parçaları kolaylıkla sökülüp temizlenebilmektedir.</div>
                                <div>Azalan personel maliyetleri</div>
                                <div>İşçi bulma sorununun çözümü</div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="text-start">
                            ...
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Genel işletme maliyetlerini azaltır.</div>
                                <div>İşletmeye prestij kazandırır.</div>
                                <div>Ayarlanabilir motor hızı.</div>
                                <div>Yağ izolasyonlu döner motoru.</div>
                                <div>Döner ızgarasının ileri geri hareketi.</div>
                                <div>Artan kalite</div>
                                <div>Tutarlı lezzet</div>
                                <div>Azaltılmış üretim maliyetleri</div>
                                <div>Gelişmiş rekabet gücü</div>
                                <div>İş kazalarının azalması</div>
                                <div></div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 py-12">
                        <div className="text-start">
                            ...
                            <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-2xl md:text-2xl sm:text-lg xs:text-lg">
                                <div>Sabit düşük ücret</div>
                                <div>Peşinat yok</div>
                                <div>Yatırım gerektirmez</div>
                                <div>4 saat içinde onay</div>
                                <div>İşletme sermayesinin optimum kullanımı</div>
                                <div>Yüksek satın alma maliyeti yok</div>
                                <div>Leasing şirketinin taşıdığı ekonomik risk</div>
                                <div>Mülkiyet imkanı</div>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Kullanım kolaylığı</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Kullanımı son derece basit olan döner robotları, personelin daha hızlı ve daha verimli çalışmasını sağlayarak mutfak işlemlerini daha verimli hale getirir.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full  lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Hız ve Verimlilik</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Otomatik döner robotları restoranların hızlı servis vermesini sağlar. Kısa sürede kaliteli hizmet sunan işletmeler için idealdir.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 text-4xl font-bold items-center justify-center flex">Tasarruf</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Döner robotları, insan emeğine olan ihtiyacı azaltarak maliyetleri düşürür. Bu, personel maliyetlerinden tasarruf sağlar ve iş süreçlerini daha verimli hale getirir.</div>
                            </div>
                        </div>
                    </div>
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 py-8 ">
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Özelleştirilebilirlik</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Döner robotları farklı menülere ve müşteri taleplerine göre programlanabilmekte, hizmet kalitesini artırmakta ve müşteri memnuniyetini en üst düzeye çıkarmaktadır.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Inovasyon</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Döner robotları sürekli olarak güncellenmekte ve yeni özelliklerle donatılmaktadır. Bu, işletmelerin rekabet üstünlüğünü korumasına yardımcı olur.</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full lg:p-8 md:p-8 sm:p-2 xs:p-2">
                            <div className="shadow-lg shadow-black rounded-[40px] h-full w-full">
                                ...
                                <div className="lg:p-8 md:p-8 sm:p-2 xs:p-2 lg:text-4xl md:text-4xl sm:text-3xl xs:text-3xl text-red-500 font-bold items-center justify-center flex">Minimum Hata Oranı</div>
                                <div className="lg:p-8 md:p-8 sm:px-6 xs:px-6 sm:pb-4 xs:pb-4 text-justify">Programlanan parametreler dahilinde çalışan döner robotları insan hatasını en aza indirir. Bu, her zaman tutarlı ve başarılı sonuçlar sağlar.</div>
                            </div>
                        </div>
                    </div>
                    <div className="p-8 w-full h-full">
                        <Button className="bg-[#cf0a2c] w-full h-full text-lg text-white"><Link href={"/tr/contact"}>Bize Ulaşın</Link></Button>
                    </div>
                </div>  
            </div>
        </div>
