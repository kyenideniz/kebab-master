    ...
    return (
        <div className="p-2 w-full">
            <div className="p-12 w-full items-center justify-center flex">
                <div className="max-w-6xl grid grid-cols-5 w-full space-x-3 relative "> 
                    <div className="col-span-3 grid w-full px-12 pt-12 shadow-lg shadow-gray-800">
                    ...
                    <div className="col-span-3 row-span-1 row-start-4">
