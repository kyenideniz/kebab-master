...
export default function Home() {
  ...
  return (
    <div className="p-2 w-full">
        ...
        <div className="max-w-7xl w-full">
          <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="border-t py-6 text-3xl font-bold" >Learn more about our machines</AccordionTrigger>
            </AccordionItem>
          </Accordion>
          ...
          <div className=" w-full h-full grid grid-rows-2 px-6">
            <div className="row-start-1 grid grid-cols-3 border-t">
              <div className="w-full h-full border-r p-4">
                ...
                <div className="text-3xl font-bold text-red-500">24/7 Operation</div>
              ...
              <div className="w-full h-full border-r p-4">
                ...
                <div className=" text-3xl font-bold text-red-500">Precision Cutting</div>
              ...
              <div className="w-full h-full  p-4">
                ...
                <div className=" text-3xl font-bold text-red-500">Easy Cleaning</div>
            ...
            <div className="row-start-2 grid grid-cols-3 border-t">
              <div className="w-full h-full border-r p-4">
                ...
                <div className="text-3xl font-bold text-red-500">Adjustable Cuts</div>
              ...
              <div className="w-full h-full border-r p-4">
                ...
                <div className="text-3xl font-bold text-red-500">Kitchen Security</div>
                ...
                <div className="w-full h-full p-4">
                  ...
                  <div className="text-3xl font-bold text-red-500">Energy Efficiency</div>
      ...
      <div className="items-center justify-center flex ">
        <div className="max-w-7xl w-full border-t">
          <div className="p-6 pt-12 grid grid-cols-2">
            <div className="grid gridrows-3 p-4 py-8">
              <div className="py-8 text-4xl font-bold ">Reach out easily!</div>
              <div className="py-8 text-2xl text-justify">Experience top-notch machine solutions with KebabMaster. Browse a variety of options for your business needs.</div>
              <div className="py-8">
                <Button className="bg-red-500">Contact</Button>
              </div>
            </div>
            <div className="relative">
              <div className="   max-h-[190px] aspect-square bg-gray-400">
                12
              </div>
            </div>
          </div>
