      ...
      <div className="lg:p-12 sm:p-4 w-full items-center justify-center flex">
        <div className="lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg grid grid-cols-5 grid-rows-2 w-full space-x-3 relative "> 
          ...
          <div className="space-x-4 col-span-3 w-full col-start-2 row-start-2 row-span-1 absolute lg:-bottom-4 md:-bottom-4 sm:-bottom-8 xs:-bottom-8 grid grid-cols-12 ">
            <Input placeholder="Contact Adres" className="col-span-10 sm:col-span-8 xs:col-span-8 w-full lg:h-16 md:h-12 sm:h-8 rounded-none text-xl shadow-lg border-0" />
            <Button className=" bg-[#cf0a2c] col-span-2 sm:col-span-4 xs:col-span-4 lg:h-16 md:h-12 sm:h-8 lg:text-lg md:text-base sm:text-xs rounded-none"><Link href={"/nl/contact"}>Indienen</Link></Button>
          </div>
        </div>  
      </div>
        ...
        <div className="max-w-7xl w-full">
          <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="border-t-[2px] py-6 lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] font-bold" >Leer meer over onze machines</AccordionTrigger>
            </AccordionItem>
          </Accordion>
          ...
          <div className=" w-full h-full grid lg:grid-rows-2 md:grid-rows-2 sm:grid-rows-1 xs:grid-rows-1 place-items-center justify-items-center px-6">
            <div className="row-start-1 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg">
              <div className="lg:border-r-[2px] md:border-r-[2px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">24/7 Werking</div>
                <div className="py-4 text-xl text-justify">Realiseer 24/7 een continue, hygiënische en steriele werking met onze geavanceerde machine. Perfect voor het handhaven van topkwaliteitsnormen zonder compromissen.</div>
              </div>
              <div className=" lg:border-r-[2px] md:border-r-[0px] sm:border-b-[2px] xs:border-b-[2px] p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Precisie Snijden</div>
                <div className="py-4 text-xl text-justify">Ervaar de precisie van onze geavanceerde döner kebabmachines. Elke machine is ontworpen om een ​​ongeëvenaarde snijnauwkeurigheid te leveren, zodat elke snede perfect is.</div>
              </div>
              <div className="md:text-center lg:border-r-[0px]  sm:border-b-[2px] xs:border-b-[2px] lg:col-span-1 md:col-span-2 sm:col-span-1 xs:col-span-1 p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] md:items-center md:justify-center sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Gemakkelijk Schoon te Maken</div>
                <div className="py-4 text-xl lg:text-justify md:text-center sm:text-justify xs:text-justify">Onze machine is gemaakt van duurzaam roestvrij staal en zorgt voor eenvoudige reiniging en onderhoud. Geniet moeiteloos van hygiënische werkzaamheden met een strak, modern ontwerp dat aan alle sanitaire normen voldoet.</div>
              </div>
            </div>
            ...
            <div className=" row-start-2 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:max-w-6xl md:max-w-5xl sm:max-w-3xl xs:max-w-lg">
              <div className="lg:border-r-[2px] lg:border-b-0 md:border-r-[2px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Verstelbare Snitten</div>
                <div className="py-4 text-xl text-justify">Onze machine beschikt over programmeerbare snijhoeken en -duur, waardoor u nauwkeurige controle over elk sneetje krijgt. Pas uw instellingen eenvoudig aan voor optimale resultaten en consistentie.</div>
              </div>
              <div className="lg:border-r-[2px] lg:border-b-0 md:border-r-[0px] md:border-t-[0px] sm:border-b-[2px] xs:border-b-[2px] p-4 h-full">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] sm:items-center sm:justify-center xs:items-center xs:justify-center flex">Keukenbeveiliging</div>
                <div className="py-4 text-xl text-justify">Om een ​​veilige werkomgeving te garanderen, is onze machine voorzien van een noodstopknop voor extra gemoedsrust. Geef prioriteit aan veiligheid zonder de efficiëntie in gevaar te brengen.</div>
              </div>
              <div className="md:text-center lg:border-r-[0px] md:border-b-0 sm:border-b-[0px] xs:border-b-[0px] lg:col-span-1 md:col-span-2 sm:col-span-1 xs:col-span-1 p-4">
                ...
                <div className="lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] py-8 font-bold text-[#cf0a2c] md:items-center md:justify-center sm:items-center sm:justify-center xs:items-center xs:justify-center flex ">Energie-Efficiëntie</div>
                <div className="py-4 text-xl lg:text-justify md:text-center sm:text-justify xs:text-justify">Realiseer kostenbesparingen dankzij het lage energieverbruik van onze machine, ontworpen voor efficiëntie zonder dat dit ten koste gaat van de prestaties. Optimaliseer uw activiteiten en verminder moeiteloos de overheadkosten.</div>
              </div>
        ...
        <div className="max-w-7xl w-full border-t-[2px]">
          <div className="lg:p-6 md:p-6 sm:p-0 xs:p-0 lg:pt-12 md:pt-12 sm:pt-0 xs:pt-0 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-4 xs:grid-cols-4 ">
            <div className="lg:p-4 lg:py-8 md:p-4 md:py-8 sm:p-2 sm:py-0 xs:p-2 xs:py-0 lg:col-span-1 md:col-span-1 sm:col-span-3 xs:col-span-3">
              <div className="lg:py-6 md:py-6 sm:py-2 xs:py-2 text-4xl lg:text-[1.875rem] md:text-[1.675rem] sm:text-[1.475rem] xs:text-[1.475rem] font-bold">Neem gemakkelijk contact op!</div>
              <div className="lg:py-6 md:py-6 sm:py-2 xs:py-2  lg:text-2xl md:text-2xl sm:text-lg xs:text-base lg:text-justify md:text-justify sm:text-left xs:text-left">Ervaar eersteklas machineoplossingen met DonerRobot. Blader door een verscheidenheid aan opties voor uw zakelijke behoeften.</div>
              <div className="py-6">
                <Button className=" bg-[#cf0a2c] lg:h-16 md:h-16 sm:h-10 xs:h-10 w-1/3 lg:text-xl md:text-xl sm:text-base xs:text-base rounded-none"><Link href={"/nl/contact"}>Contact</Link></Button>
              </div>
            </div>
